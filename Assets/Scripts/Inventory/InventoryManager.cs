...
public class InventoryManager : MonoBehaviour
{
    ...
    public InventorySlot equippedMask;
    public InventorySlot equippedArmor;
    ...
    public bool EquipItem(ItemStack item, InventorySlot slot)
    {
        if(slot == null)
        {
            item.equippedIn.SetItem(null);
        ...
        else
        {
            ...
            {
                if (item.item.itemSlot == slot.itemSlotType)
                {
                    slot.SetItem(item);
